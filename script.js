...
const translations = {
  ...
  tig: {
    ...
    'announcement':            'ህፁፅ ሕክምናዊ ግልጋሎት 24/7 ክፉት እዩ — ደውሉ +251 920 008 338',

    /* B — Hero */
    'hero-badge':              'ብሓልዮትና ንምረጽ፡ ብሞያዊ ብቕዓትና ንእመን።',
    'hero-title':              'መሪሕን ብሉጽን ማእከል ሕክምና ።',
    'hero-sub':                'ዓለም-ለኻዊ ደረጃ ዘማለአ ሆስፒታል — ዘመናዊ ቴክኖሎጂ፣ ብቑዓት ሓካይም፣ ናይ 24 ሰዓት ህፁፅ ሕክምናዊ ረድኤት።',
    'hero-btn-appointment':    'ቆፀሮ ሓዙ',
    'hero-btn-services':       'ግልጋሎታት ርአ',
    'stat-services':           'ክፍሊታት ሕክምና',
    'stat-doctors':            'ስፔሻሊስት/ሳብ ስፔሻሊስት ሓኻይም',
    'stat-emergency':          'ሃንደበታ ሕክምና',

    /* C — Quick-access cards */
    'qa-appt':                 'ቆፀሮ ሓዙ',
    'qa-appt-sub':             'ኦንላይን ይመዝገቡ',
    'qa-doctors':              'ሓኪም ረኽቡ',
    'qa-doctors-sub':          'ስፔሻሊስትን ሰብ-ስፔሻሊስትን',
    'qa-services':             'ግልጋሎታትና',
    'qa-services-sub':         '18+ ክፍሊታት',
    'qa-emergency':            'ሃንደበታዊ ረድኤት',
    'qa-emergency-sub':        '+251 920 008 338',
    ...
    'service1-h3':             'ሕክምና ውሽጣዊ ሕማማት ',
    'service2-h3':             'ሕክምና ሕማማት ልቢ',
    'service3-h3':             'ሕክምና ሓፈሻዊ ሕክምና',
    'service4-h3':             'ሕክምና ህጻናትን ኣባጽሕን',
    'service5-h3':             'ሕክምና ነፍሰጾራትን ደቂኣንስትዮን',
    'service6-h3':             'ሕክምና ካብ ክሳድ ንላዕሊ',
    'service7-h3':             'ራድዮሎጂ',
    'service8-h3':             'ሕክምና ስኒ',
    'service9-h3':             'ኒውሮሰርጀሪ',
    'service10-h3':            'ኦርቶፔዲክስ',
    'service11-h3':            'ደርማቶሎጂን ኮስመቶሎጂን',
    'service12-h3':            'ሕክምና መደንዘዝን ምክትታል ቃንዛን',
    'service13-h3':            'ላብራቶሪ',
    'service14-h3':            'ፊዝዮቴራፒ',
    'service15-h3':            'ሳይካትሪ',
    'service16-h3':            'ግልጋሎታት ማትርኒቲ',
    ...
    'service2-desc':  'ብዛዕባ ልብን ናይ ልቢ ሕማማትን ዘትኮረ ምዕቡል መርመራን ሕክምናን ብሳብ-ስፔሻሊስት ሓኻይም ይወሃብ።',
    'service3-desc':  'ብልዑል ብቕዓት ዘለዎም ሰርጀን ዝካየድ ውሑስን ብቑዕን ናይ ቀዶ ሕክምና ግልጋሎትሎት ይወሃብ።',
    'service4-desc':  'ካብ ናይ ህፃናት ዕድመ ክሳዕ ናይ ኣባፅሕ ዕድመ ንዘሎ ህፃናት መንእሰያትን ምሉእ ናይ ምርመራ፣ ሕክምናን ጥዕና ክንክንን ይወሃብ።',
    'service5-desc':  'ካብ ናይ ቅድመ- ወሊድን ድሕሪ ወሊድ (ሕርሲ) ዝርዝር ዘጠቓልል ምሉእ ናይ ደቀንስትዮ ሕክምናዊ ግልጋሎት ብስፔሳሊት ሓኻይም ይወሃብ።',
    'service6-desc':  'ናይ እዝኒ፡ ኣፍንጫን ጒሮሮን ምስ ርእሲን ክሳድን ዝተኣሳሰሩ ሕማማት ዝምርምርን ዝፍውስን ብኢንዶስክፒ ማሽን ተሓጊዙ ግልጋሎት ይወሃብ።',
    'service7-desc':  'ብኤክስ-ሬይ፡ ኣልትራሳውንድን ሲቲ-ስካንን ዘጠቓልል ዘመናዊ ናይ ምስሊ ምርመራ ግልጋሎት ይወሃብ።',
    'service8-desc':  'ናይ ምክልኻልን ምሕዳስን ምስ ናይ ምምልኻዕ (ከም ብረስ ምእሳር፣ኣርተፊሻል ስኒ ምትካልን) ምሉእ ናይ ስኒ ሕክምና ዘጠቓልል ምሉእ ግልጋሎ ይወሃብ።',
    'service9-desc':  'ናይ ሓንጎልን ናይ ነርቭ ስርዓት ሕማማት ዝምልከት  ማለት ሕማማት ሓንጎል፣ ዓንዲ ሕቆን መትንን ዝወሃብ ፍሉይ ናይ መጥባሕቲ ሕክምና ብስፔሻሊስት ሓኻይም ይወሃብ።',
    'service10-desc': 'ንዘጋጥሙ ጕድኣታትን ናይ ዓጽሚ፣ መላገቦ (Joint) ከምኡ እውን ጭዋዳታትን ዓጽምን (Musculoskeletal) ብልዑል ሞያን ልምዲን ዘለዎም ብስፔሻሊት ሓኻይም ይወሃብ።',
    'service11-desc': 'ናይ ቆርበት ሕማማት ሕክምና ምስ ዘመናዊ ናይ ስነ-ጽባቐን ግልጋሎት ብስፔሻሊስት ሓኻይም ይወሃብ።',
    'service12-desc': 'ንነፍሲ ወከፍ ሕሙም ዝወሃብ ውሑስ ናይ መደንዘዚ ግልጋሎት (Anesthesia) ግልጋሎትን  ምስ ውልቃዊ ናይ ቃንዛ ዝከታተል ማሽን (Pain Management) ግልጋሎት ይወሃብ።',
    'service13-desc': 'ትኽክለኛ ክሊኒካዊ ወይ ሕክምናዊ ውሳነ ንምሃብ ዝሕግዙ፡ ቅልጡፋትን ዘተኣማምኑን ምሉእ ናይ ላቦራቶሪ መርመራታት ብዘመናዊ ማሽናት ግልጋሎት ይወሃብ።።',
    'service14-desc': 'ናብ ንቡር ንምምላስ ዝዓለመ ምንቅስቓስ ኣካላትን ሓይሊ ጭዋዳታትን ዝወሃቡ፡ ፍሉያት ናይ ተሃድሶን ፊዚዮተራፒን ሕክምናታት ግልጋሎት ንህብ።',
    'service15-desc': 'ናይ ስነ-ኣእምሮ ጥዕና መርመራ፡ ምኽርን ሕክምናን ብሓልዮትን ሞያዊ ብቕዓትን ዘለዎም ስፔሻሊስት ሓኻይም ግልጋሎትይወሃብ።',
    'service16-desc': 'ንኣዴታትን ንህጻናትን ዝምልከት ቅድመ ወሊድን ድሕረ ወሊድን(ሕርስ) ግልጋሎት ብልዑል ሞያን ልምዲን ዘለዎም ሽፔሻሊስት ሓኻይም ግልጋሎት ይወሃብ።',
    'service17-desc': 'ኩሉ ግዜ 24/7 ክፉት ዝኾነ መድሓኒት ቤትን(Pharmacy) ንሃንደበታዊ ሓደጋታት ዝኸውን ቅልጡፍ ናይ ኣምቡላንስ ግልጋሎትን ንህብ።',
    'service18-desc': 'ድሌታት ሕሙማትና ንምምላእ ዝወሃቡ ዝተፈላለዩ ተወሳኺ ናይ ስፔሻሊስት ሕክምናዊ ግልጋሎታት ንህብ።',

    /* F — Services section headings */
    'services-eyebrow':        'እንህቦ',
    'our-services-h2':         'ሕክምናዊ ግልጋሎታትና',
    ...
    'dr-tesfay-specialty':     'ሳብ ስፔሻሊስት ኢንተርቨንሽናል ካርዲዮሎጂ',
    ...
    'patient-info-p':          'እውናዊን ኣገዳሲን ዝኾነ ሓበሬታ ንምርካብ፣ ናብ/ካብ ቀጽሪ ሆስፒታል ምእታው፣ ምውጻእ፣ መሰላትን ሓላፍነታትን ተመልከቱ።',
    'articles-h2':             'ጽሑፋት ጥዕና',
    'articles-p':              'ካብቶም ብቑዓት ሰራሕተኛታትና ንዝመጹ ሓደሽቲ ጽሑፋት ጥዕና፣ ፍልጠትን ሕክምናዊ ሓበሬታን ተኸታተሉ።',

    /* J — Appointment form & testimonial */
    'testimonial-p':           'ሓካይምን ሰራሕተኛታትን ናይ ግዕዝ ሆስፒታል ብሓቂ ዝድነቑን ምስጉናትን እዮም — እቲ ሓልዮቶምን ብቕዓቶምን ፍልይ ዝበለ እዩ።ስለእቲ ዝገብሩለይ ሕክምናዊ ግልጋሎትን ሓልዮትን ፍልይ ዝበለ ኣዩ ነይሩ። ብጣዕሚ ድማ ኣመስግኖም።',
    ...
    /* L — Footer */
    'footer-brand-desc':       'ብሓልዮትና ንምረጽ፡ ብሞያዊ ብቕዓትና ንእመን!።',
    'footer-quick-links':      'ቅልጡፍ ሊንካት',
    'footer-services-title':   'ዋና ግልጋሎታት',
    'footer-contact-title':    'ርኸቡና',
    'footer-address':          'ጣብያ ክንደያ፣ ቅድሚ ኢትዮ-ቴሌኮም፣ ድሕሪ ሴንትራል ካፌ፣ ኣኽሱም፣ ትግራይ፣ ኢትዮጵያ',
  ...
  amh: {
    ...
    'footer-text':             'የቅጂ መብት © 2026 ግዕዝ ሆስፒታል | ለገሰ ተክሉ ገብረኪዳን  — 0911179955',
  }
}; /* end translations */
