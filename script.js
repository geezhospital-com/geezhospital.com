...
const translations = {
    ...
    "eng": {
        ...
        "hero-main-title": "Geez Hospital", // New Title
        "hero-tagline-eng": "Chosen for our care, trusted for our expertise", // New English Tagline
    ...
    "amh": {
        ...
        "services-page-intro-p": "ግዕዝ ሆስፒታል በተለያዩ እና ዘመናዊ አገልግሎቶችን በስፔሻሊስቶች እና በሳብስፔሻሊስቶች (sub specialist) ብቃት ባላቸው ሀኪሞች ይሰጣል።",
        "service1-h3": "የውስጥ ደዌ ህክምና ስፔሻሊስት",
        "service1-p": "ሙሉ የውስጥ ደዌ ህክምና ምርመራ እና ህክምና በከፍተኛ ልምድ እና ሙያ ባላቸው ስፔሻሊስት ሀኪሞች ይሰጣል። ይህ አገልግሎት እንደ የደም ግፊት፣ የኩላሊት ህመም፣ የሳንባ ህመም፣ የሆርሞን ህመም፣ ወዘተ የመሳሰሉ የተለያዩ ህመሞችን ያጠቃልላል።",
        "service2-h3": "የልብ ህክምና ሳብ-ስፔሻሊስት",
        "service2-p": "ልዩ የልብ ህመም ምርመራ እና ህክምና በከፍተኛ ልምድ እና ሙያ ባላቸው ሳብ-ስፔሻሊስት ሀኪሞች ይሰጣል። ECG፣ Echocardiography፣ Stress Test የመሳሰሉ ዘመናዊ መሳሪያዎችን እና አሰራሮችን እንጠቀማለን።",
        "service3-h3": "አጠቃላይ የቀዶ ህክምና ስፔሻሊስት",
        "service3-p": "አጠቃላይ የቀዶ ህክምና በዘመናዊ መሳሪያዎች እና አሰራሮች ይሰጣል። ይህ ለተለያዩ እንደ አፐንዲክስ፣ ሄርኒያ፣ ሀሞት ከረጢት፣ ወዘተ የመሳሰሉ ቀዶ ህክምናዎችን ያጠቃልላል።",
        "service4-h3": "የህፃናት እና ወጣቶች ህክምና ስፔሻሊስት",
        "service4-p": "የህፃናት እና ወጣቶች ምርመራ እና ህክምና በስፔሻሊስት ሀኪም ይሰጣል። ለህፃናት ተስማሚ ልዩ እንክብካቤ እንሰጣለን።",
        "service5-h3": "የማህፀንና ፅንስ ህክምና ስፔሻሊስት",
        "service5-p": "ሙሉ የማህፀንና ፅንስ ምርመራ እና ህክምና በስፔሻሊስት ሀኪም ይሰጣል። ከወሊድ በፊት፣ በወሊድ ጊዜ እና ከወሊድ በኋላ የሚያስፈልገውን እንክብካቤ እንሰጣለን።",
        "service6-h3": "ከአንገት በላይ ህክምና ስፔሻሊስት (ENT)",
        "service6-p": "የአንገት፣ የጆሮና የአፍንጫ ምርመራ እና ህክምና በስፔሻሊስት ሀኪም ይሰጣል። ለተለያዩ ENT ህመሞች በዘመናዊ መሳሪያዎች (Endoscopy) ምርመራ እና ህክምና እንሰጣለን።",
        "service7-h3": "የራዲዮሎጂ ስፔሻሊስት (አልትራሳውንድ፣ ራጅ፣ ሲቲ ስካን እና ECG)",
        "service7-p": "ዘመናዊ የራዲዮሎጂ አገልግሎት (አልትራሳውንድ፣ ራጅ፣ ሲቲ ስካን እና ECG) በስፔሻሊስት ሀኪም ይሰጣል። ትክክለኛ ምርመራ ለመስጠት የሚያግዝ ዘመናዊ ቴክኖሎጂ እንጠቀማለን።",
        "service8-h3": "የጥርስ ህክምና ስፔሻሊስት",
        "service8-p": "ሙሉ የጥርስ ህክምና በስፔሻሊስት ሀኪም ይሰጣል። ከንፁህ ጥርስ እስከ ዘውድ እና ጥርስ መተካት ድረስ ያሉ አገልግሎቶችን እንሰጣለን።",
        "service9-h3": "የነርቭ፣ የአከርካሪ አጥንት እና የአንጎል ቀዶ ህክምና ስፔሻሊስት",
        "service9-p": "የነርቭ፣ የአከርካሪ አጥንት እና የአንጎል ቀዶ ህክምና በከፍተኛ ልምድ ባላቸው ስፔሻሊስት ሀኪሞች ይሰጣል። ለተለያዩ የነርቭ ህመሞች ልዩ ህክምና እንሰጣለን።",
        "service10-h3": "የአጥንትና መገጣጠሚያ፣ ነርቭና አከርካሪ ህክምና ስፔሻሊስት",
        "service10-p": "የአጥንትና መገጣጠሚያ፣ ነርቭና አከርካሪ ህክምና በስፔሻሊስት ሀኪም ይሰጣል። ለአጥንት ስብራት፣ ቁስለት እና የመገጣጠሚያ ህመሞች ህክምና እንሰጣለን።",
        "service11-h3": "የቆዳ፣ ሌዘር እና ኮስሞቲክስ ህክምና ስፔሻሊስት",
        "service11-p": "የቆዳ፣ ሌዘር እና ኮስሞቲክስ ህክምና በስፔሻሊስት ሀኪም ይሰጣል። ለተለያዩ የቆዳ ህመሞች ውስጣዊም ሆነ ውጫዊ እንክብካቤ እንሰጣለን።",
        "service12-h3": "የማደንዘዣ እና የህመም ማስታገሻ ስፔሻሊስት",
        "service12-p": "የማደንዘዣ እና የህመም ማስታገሻ ህክምና በስፔሻሊስት ሀኪም ይሰጣል። ከቀዶ ህክምና በፊት እና በኋላ የሚያስፈልገውን እንክብካቤ እንሰጣለን።",
        "service13-h3": "ሙሉ ዘመናዊ ላቦራቶሪ",
        "service13-p": "ሙሉ ዘመናዊ የላቦራቶሪ አገልግሎት ይሰጣል። ሁሉንም አይነት የደም፣ የሽንት እና ሌሎች ባዮሎጂካል ምርመራዎችን በዘመናዊ መሳሪያዎች እናከናውናለን።",
        "service14-h3": "የፊዚዮቴራፒ ምርመራ እና ህክምና",
        "service14-p": "ሙሉ የፊዚዮቴራፒ ምርመራ እና ህክምና በፊዚዮቴራፒስት ይሰጣል። ለተለያዩ የአካል ቅርፅ እና እንቅስቃሴ ህመሞች ህክምና እንሰጣለን።",
        "service15-h3": "የስነ-አእምሮ ህክምና ስፔሻሊስት",
        "service15-p": "የስነ-አእምሮ ህክምና አገልግሎት ይሰጣል። ለተለያዩ የአእምሮ ህመሞች ምክር እና ህክምና እንሰጣለን።",
        "service16-h3": "ሙሉ የእናቶችና ህፃናት አገልግሎት",
        "service16-p": "ሙሉ የእናቶችና ህፃናት አገልግሎት፣ ከወሊድ በፊት እስከ ወሊድ በኋላ፣ በከፍተኛ ልምድና ሙያ ባላቸው ባለሙያዎች፣ በስፔሻሊስት ሀኪም እና በዘመናዊ መሳሪያዎች ይሰጣል።",
        "service17-h3": "ሙሉ የመድሃኒት አቅርቦት (ፋርማሲ) እና አምቡላንስ",
        "service17-p": "ሙሉ የመድሃኒት አቅርቦት (ፋርማሲ) እና አምቡላንስ አገልግሎት ይሰጣል። 24 ሰዓት የፋርማሲ እና አምቡላንስ አገልግሎት ዝግጁ ነው።",
        "service18-h3": "ሌሎች አገልግሎቶችም አሉ",
        "service18-p": "ግዕዝ ሆስፒታል ለህብረተሰቡ ሌሎች ያልተዘርዘሩ አገልግሎቶችንም ይሰጣል። ለማንኛውም ጥያቄ ወይም ተጨማሪ መረጃ መጠየቅ ይቻላል።",
